    ...
    if (choice3 == " yes" or "yes"):
      ...
      if choice4 == " cross the bridge" or "cross the bridge":
        ...
        if choice5 == " left" or "left":
          print("\nYou open the left door and find a staircase which you descend, preparing to meet whoever is playing such a melancholy song on the piano.")
          ...
          if choice6 == " middle" or "middle":
            print("You're too hungry to continue further and make your way through the middle door. After that nasty trick in the last room, you're more than a little wary of whatever you smell roasting but when you finally enter what appears to be a small kitchen, you're met with..")
            ...
            if choice7 == " leave the room" or "leave the room":
              print("An warm kitchen with a roasting turkey over a freshly-lit fire in an otherwise abandoned ruin is way too suspicious. You may be hungry but even you know poison doesn't settle a stomach very well.")
        ...
        if choice5 == " middle" or "middle":
          ...
          if choice12 == " eat the turkey" or "eat the turkey":
            ...
            if choice13 == " left" or "left":
              ...
              print("...")
              print("You spare a glance outside as you make your way to the right door and corner of your eye you spot a figure standing a few yards away outside. They appear to be staring at you.")
              print("You don't recognize who it is...")
              print("...The figure isn't moving...")
              choice14 = input('It\'s starting to creep you out but that person could know more about this place What do you do? Type "approach the figure" or "continue on through the right door".')
              if choice14 == " approach the figure" or "approach the figure":
                print("You travel back to ")